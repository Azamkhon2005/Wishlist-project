...
- Ранее могли применяться схемы без фиксированных параметров.
...
- Минусы: рост затрат CPU/памяти при регистрации/смене пароля — приемлемо.

## Alternatives
- bcrypt/scrypt/PBKDF2 — допустимы, но не соответствуют выбранному стандарту в NFR-01.
